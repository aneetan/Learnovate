...
const HeroSection = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center bg-gradient-to-br from-gray-900 to-gray-800 overflow-hidden">
      {/* Shapes */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute w-[400px] h-[400px] bg-gradient-to-br from-teal-500 to-teal-300 rounded-full opacity-10 -top-24 -left-24 sm:w-[500px] sm:h-[500px]" />
        <div className="absolute w-[300px] h-[300px] bg-gradient-to-br from-blue-500 to-blue-700 rounded-full opacity-10 -bottom-12 -right-12 sm:w-[400px] sm:h-[400px]" />
        <div className="absolute w-[200px] h-[200px] bg-gradient-to-br from-purple-500 to-purple-700 rounded-full opacity-10 top-[30%] right-[15%] sm:w-[250px] sm:h-[250px]" />
        <div className="absolute w-[150px] h-[150px] bg-gradient-to-br from-pink-500 to-pink-700 rounded-full opacity-10 bottom-[20%] left-[10%] sm:w-[200px] sm:h-[200px]" />
      </div>

      {/* Container */}
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 items-start z-10 py-16 sm:py-24">
        {/* Content */}
        <motion.div
        ...
        >
          ...
          >
            Find Your Perfect <span className="color--primary-color">Mentor</span> and Accelerate Your Career
          </motion.h1>

          <motion.p
            className="text-base sm:text-lg md:text-xl text-white/80 mb-8 max-w-[90%]"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
          >
          ...
          >
            <Link
              to="/register"
              className="btn-primary px-6 py-3 rounded-lg font-medium shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all duration-300 text-center"
      ...
      <Link
        to="/register"
        className="bg-transparent border-2 border-white/30 !text-white px-6 py-3 rounded-lg font-medium hover:bg-white/10 hover:border-white/50 transition-all duration-300 text-center"
      ...
      >
        ...
        >
          <div className="relative rounded-2xl shadow-2xl max-w-[90%] mx-auto lg:max-w-full">
            <img
              src="https://images.unsplash.com/photo-1543269865-cbf427effbad?ixlib=rb-4.0.3&auto=format&fit=crop&w=1770&q=80"
